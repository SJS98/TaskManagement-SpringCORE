...
.emp-img{
	height:150px;
	width:150px;
	background: url(https://cdn2.iconfinder.com/data/icons/business-office-1-9/100/1-13-1024.png);
	background-position: center;
...
.emp-detail table tr th,
.emp-detail table tr td{
	width:350px;
	text-align: center;
	border-radius: 10px;
}
		...
		<div class="all-emp-details">
			...
			<div class="emp-card">
				...
				<table >
					...
					<tr>
						<td><%=user.getEmail()%></td>
						<td><%= (int)user.getTasks().stream().filter(t->t.getStatus().equals("Completed")).count() >= user.getTasks().size() ? "Hard Working" : "Poor"%></td>
					</tr>
